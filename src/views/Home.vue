  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="row actual_version_color">
        ...
        <div class="col-4">
          <p>Добавлен revision_priority индекс. Заработал поиск по последним ревизиям. Теперь созранять документы можно только с правильными ревизиями</p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-4">
          <p>Удалена возможность пустого запроса при поиске в Титулы</p>
        </div>
      </div>

      <div class="row">
        <div class="col-2">
          <p>2.12.0 - 14.10.2020</p>
        </div>
        <div class="col-4">
          <p>Настройки приложения вынесены в Admin</p>
        </div>
      </div>

      <div class="row">
        <div class="col-2">
          <p>2.11.0 - 12.10.2020</p>
        </div>
        <div class="col-4">
          <p>Добавлен доступ по ролям в Admin</p>
        </div>
      </div>

      <div class="row">
        <div class="col-2">
          <p>2.10.0 - 29.09.2020</p>
        </div>
        <div class="col-4">
          <p>Добавлено кол-во не проверенных документов</p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-4">
          <p>Размер файлов в Лог и Отправке увеличен до 1000 Мб</p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-4">
          <p>Размер файлов в Отправке увеличен до 500 Мб</p>
        </div>
      </div>

      <div class="row">
        <div class="col-2">
          <p>2.7.5 - 21.03.2020</p>
        </div>
        <div class="col-4">
          <p>Код НИИК включен по умолчанию в поиске документов</p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-4">
          <p>Отремонтирована кодировка русских имен скачиваемых файлов в Пакуй.</p>
        </div>
      </div>
